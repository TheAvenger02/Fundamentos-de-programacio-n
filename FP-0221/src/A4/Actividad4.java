...
Scanner sc = new Scanner(System.in);
 ...
 int r = (int) ((Math.random() * 101, n, t = 10;

do{
System.out.println("Ingrese su intento para adivinar: "); 
n = sc.nextInt();

if( n < r || n > r){
t--;
if( t > 0){
System.out.println("Te quedan: "+t+" turnos"); 
System.out.println("Ingrese un número más: "+(n < r ? "grande" : "pequeño")); 
}
}

}while( r != n && t > 0 );
System.out.println(t == 0 ? "PERDISTE, el número era: " + r : "¡ADIVINASTE EL NÚMERO!"); 
